...
class ResultData {
  ...
  static Future<List<ResultModel>> fetchFishData({int page = 1, String libelle_station=''}) async {
    final url = Uri.parse('$baseUrl?page=$page&size=10&libelle_station=$libelle_station');
